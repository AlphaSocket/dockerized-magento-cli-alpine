...
ADD imports/bin/setup /usr/local/bin/setup/1519336270
ADD imports/bin/config /usr/local/bin/config/1519336270


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519336270 1>/dev/stdout 2>/dev/stderr
