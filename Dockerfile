...
ADD imports/bin/setup /usr/local/bin/setup/1518486087
ADD imports/bin/config /usr/local/bin/config/1518486087


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518486087 1>/dev/stdout 2>/dev/stderr
