...
ADD imports/bin/setup /usr/local/bin/setup/1519336272
ADD imports/bin/config /usr/local/bin/config/1519336272


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519336272 1>/dev/stdout 2>/dev/stderr
