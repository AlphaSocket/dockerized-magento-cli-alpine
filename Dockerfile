...
ADD imports/bin/setup /usr/local/bin/setup/1518485818
ADD imports/bin/config /usr/local/bin/config/1518485818


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518485818 1>/dev/stdout 2>/dev/stderr
