...
ENV \
	...
	SETUP_DEPENDENCIES_SETUP="bash curl gettext git  mysql-client nodejs nodejs-npm python py-pip php5 php5-phar php5-soap php5-iconv php5-xml php5-json php5-zlib php5-gd php5-ctype php5-gd php5-pdo_mysql php5-dom php5-mcrypt php5-curl" \
