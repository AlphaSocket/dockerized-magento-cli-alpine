...
ADD imports/bin/setup /usr/local/bin/setup/1518487483
ADD imports/bin/config /usr/local/bin/config/1518487483


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518487483 1>/dev/stdout 2>/dev/stderr
