...
ADD imports/bin/setup /usr/local/bin/setup/1518487632
ADD imports/bin/config /usr/local/bin/config/1518487632


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518487632 1>/dev/stdout 2>/dev/stderr
