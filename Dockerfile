...
ENV \
	...
	SETUP_DEPENDENCIES_MANAGEMENT="bash htop curl git mysql-client fcgi" \
	...
	SETUP_DEPENDENCIES_RUNTIME="bash htop curl git mysql-client fcgi nodejs nodejs-npm $SETUP_DEPENDENCIES_SECURITY php5 php5-phar php5-soap php5-iconv php5-xml php5-json php5-zlib php5-gd php5-ctype php5-gd php5-pdo_mysql php5-dom php5-mcrypt php5-curl php5-openssl php5-opcache" \
...
ADD imports/bin/setup /usr/local/bin/setup/1519352340
ADD imports/bin/config /usr/local/bin/config/1519352340


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519352340 1>/dev/stdout 2>/dev/stderr
