...
ADD imports/bin/setup /usr/local/bin/setup/1519338657
ADD imports/bin/config /usr/local/bin/config/1519338657


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519338657 1>/dev/stdout 2>/dev/stderr
