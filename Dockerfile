...
ADD imports/bin/setup /usr/local/bin/setup/1519337210
ADD imports/bin/config /usr/local/bin/config/1519337210


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519337210 1>/dev/stdout 2>/dev/stderr
