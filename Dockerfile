...
ADD imports/bin/setup /usr/local/bin/setup/1519340747
ADD imports/bin/config /usr/local/bin/config/1519340747


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519340747 1>/dev/stdout 2>/dev/stderr
