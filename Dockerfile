...
ENV \
	...
	SETUP_DEPENDENCIES_RUNTIME="bash htop curl git mysql-client  $SETUP_DEPENDENCIES_SECURITY php5 php5-phar php5-soap php5-iconv php5-xml php5-json php5-zlib php5-gd php5-ctype php5-gd php5-pdo_mysql php5-dom php5-mcrypt php5-curl php5-openssl php5-opcache" \
